...
public class MultipleAddressBooks {
    ...
    public static void main(String[] args) {
        ...
        Hashtable<String, AddressBooks> MultipleAddressBooks = new Hashtable<String, AddressBooks>(); // dictionary for
                                                                                                      // mapping
                                                                                                      // different
                                                                                                      // address book
                                                                                                      // with key i.e unique name
        AddressBooks address_book = new AddressBooks(); // first address book object

        String n = "";
        String k = "AddressBook1";
        MultipleAddressBooks.put(k, address_book); // put the first address book into dictionary
        ...
        while (true) {
            ...
            if (choice == 6) // to create a new address book
            {
                ...
                MultipleAddressBooks.put(n, object1);
                ...
                n = sc.next();
                choice(choice, MultipleAddressBooks.get(n)); // to perform required operation on desired address book
            }
        }
    }
}